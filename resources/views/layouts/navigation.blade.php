<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- KEPEGAWAIAN MENU -->
                    <x-nav-link :href="route('kepegawaians.index')" :active="request()->routeIs('kepegawaians.*')">
                        {{ __('Kepegawaian') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('perencanaans.index')" :active="request()->routeIs('perencanaans.*')">
                        {{ __('Perencanaan') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- MOBILE: KEPEGAWAIAN -->
            <x-responsive-nav-link :href="route('kepegawaians.index')" :active="request()->routeIs('kepegawaians.*')">
                {{ __('Kepegawaian') }}
            </x-responsive-nav-link>
